...
function union_of_two_sorted_array_with_duplicates ( arr1, arr2 ) {
  ...
  const arr2 = [2, 3, 4, 4, 5, 11, 12, 12];
  
  console.log( union_of_two_sorted_array_with_duplicates ( arr1, arr2 ) );
